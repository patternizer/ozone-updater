% function read_extract_woudc_MSC()

%--------------------------------------------------------------------------
% Called by load_woudc_MSC.bat:
%
...
% matlab -nosplash -nodesktop -noFigureWindows -r "try; run('C:\Users\patternizer\Downloads\read_extract_woudc_MSC.m'); catch; end; quit"
%--------------------------------------------------------------------------
% Dr. Michael Taylor: 
...
disp(['IN: read_extract_woudc_MSC']);

%% PARAMETERS
dir_stations = 'C:\Users\patternizer\Downloads\exp-studies.tor.ec.gc.ca\pub\ozonedata\Preliminary\MSC\';
...
disp(['OUT: read_extract_woudc_MSC']);
